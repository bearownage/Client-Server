...
SOURCES_SERVER=server.cpp cache.cpp linearprobe.cpp kvs.cpp aliaskvs.cpp aliaslinearprobe.cpp
...
clean:
	-rm $(TARGET_SERVER) $(TARGET_CLIENT) $(OBJECTS_SERVER) $(OBJECTS_CLIENT) $(DEPS)

format:
	clang-format -i *.cpp *.c *.h -style=file
